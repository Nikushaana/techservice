  ...
  return (
    <div className="flex flex-col gap-y-[30px] sm:gap-y-[50px]">
      ...
      <div className="flex flex-wrap justify-center gap-[20px] sm:gap-[40px]">
        ...
        <div className="rounded-[10px] px-[10px] sm:px-[20px] py-[10px] flex flex-col items-center gap-y-[15px] sm:gap-y-[20px] bg-myLightBlue hover:bg-myBlue duration-200 text-white  cursor-pointer group hover:hover:scale-110 w-[calc((100%-20px)/2)] sm:w-[calc((100%-80px)/3)] lg:w-[calc((100%-160px)/5)]">
